!(function(e, t) {
      ...
      computed: {
        ...
        hours: function() {
          ...
          if ('12-hour' == this.hourClock) {
            ...
            for (var n = 0; n < 12; n++) t.push(n);
          } else if ('24-hour' == this.hourClock)
            for (var a = 0; a < 24; a++) t.push(a);
          return t.map(function(t, s) {
            return { hour: t, selected: s === e.selectedHour };
          });
        },
        months: function() {
          for (var e = this, s = [], n = 0; n < 12; n++)
            this.dividedNamesOfMonths
              ? s.push(this.dividedNamesOfMonths[n])
              : s.push(t[n]);
        ...
        years: function() {
          for (
            var e,
              ...
              a = e + (this.max ? this.maxDate.getFullYear() + 1 - e : 101);
            n < a;
            n++
          )
            s.push(n);
  ...
  var n = function(e, t, s, n, a, r, i, o, l, d) {
          ...
          e.isRequested('h')
            ? s('div', { class: [e.selectWrapperClassName] }, [
                s(
                  ...
                  e._l(e.hours, function(t, n) {
                    return s('option', {
                      key: n,
                      domProps: {
                        value: n,
                        innerHTML: e._s(e.getHourForDisplay(t.hour, n))
                      }
                    });
                  }),
                  0
          ...
          if (!n.ids.has(e)) {
            ...
            if (
              ...
              var l = n.ids.size - 1,
                ...
                c = n.element.childNodes;
              c[l] && n.element.removeChild(c[l]),
                c.length
                  ? n.element.insertBefore(d, c[l])
                  : n.element.appendChild(d);
            }
          }
        })(e, t);
      };
